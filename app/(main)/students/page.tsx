        ...
        <div className="grid" style={{ width: '150vw' }}>
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <Dialog header="Invite Student" style={{ width: '50vw' }} visible={inviteStudentStatus} onHide={() => inviteStudentStatus && clearInviteStudent()} footer={addStudentFooter}>
                        <CreateInvitationComponent setEmail={setEmail} email={email} setFullName={setFullName} fullName={fullName} selectedClass={selectedClass} setSelectedClass={setSelectedClass} />
                    </Dialog>
